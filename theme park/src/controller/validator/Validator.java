...
public class Validator 
{
	...
	public static String validatePassword(String field,String password,String confirmPassword,boolean required, boolean isMatch) 
			throws RequiredFieldException, PasswordMatchException 
	{
